                ...
                for sublayer in sublayers:
                    ...
                    if sub_vlayer.isValid():
                        if sub_vlayer.crs() != self.target_crs:
                            ...
                            symbol = QgsFillSymbol.createSimple({'color': 'transparent', 'outline_color': '#0059ff', 'outline_width': 0.98})
        ...
        for f in lista_archivos:
            ...
            if layer.isValid():
                ...
                for sublayer in sublayers:
                    ...
                    sub_vlayer = QgsVectorLayer(uri, name, 'ogr')
                    sub_vlayer.setOpacity(0.7) # Establecer la transparencia en 0.x (x0%)
