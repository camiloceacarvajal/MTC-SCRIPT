...
class LayerLoader:
    ...
    def select_and_load_geopackage(self):
        ...
        if file_path:
            ...
            if not layer.isValid():
                ...
                # Eliminar la columna 'fid' si existe
                if 'fid' in [field.name() for field in layer.fields()]:
                ...
                for sublayer in sublayers:
                    ...
                    if sub_vlayer.isValid():
                        if sub_vlayer.crs() != self.target_crs:
                            ...
                            some_symbol.setOpacity(0.35)  # Opacity
    ...
    def load_template_content(self, template_content):
        ...
        if map:
            ...
            scalebar.setSegmentSizeMode(QgsScaleBarSettings.SegmentSizeMode.SegmentSizeFitWidth)# Establece el modo de tamaño de segmento a 'Fit segment width'
...
template_urls = ["https://gitlab.com/camiloceacarvajal1/plantilla_MBN/-/raw/main/22.qpt?ref_type=heads", "https://raw.githubusercontent.com/camiloceacarvajal/PLANTILLA-MBN/main/21.qpt"]
...
#tiempo estimado de ejecucion 1 minuto -"si se demora mas de 10m avisar a catastro"
#Version Desarrollo Mayo-2025-05-05🌍🗺️🌍